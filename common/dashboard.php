...
<link rel="stylesheet" type="text/css" href="/Projects/SchoolManagementSystem/styles/dashboard.css">
...
<symbol id="staff" viewBox="0 0 16 16">
	<!-- <path d="M8,0a8,8,0,1,0,8,8A8,8,0,0,0,8,0ZM8,15a7,7,0,0,1-5.19-2.32,2.71,2.71,0,0,1,1.7-1,13.11,13.11,0,0,0,1.29-.28,2.32,2.32,0,0,0,.94-.34,1.17,1.17,0,0,0-.27-.7h0A3.61,3.61,0,0,1,5.15,7.49,3.18,3.18,0,0,1,8,4.07a3.18,3.18,0,0,1,2.86,3.42,3.6,3.6,0,0,1-1.32,2.88h0a1.13,1.13,0,0,0-.27.69,2.68,2.68,0,0,0,.93.31,10.81,10.81,0,0,0,1.28.23,2.63,2.63,0,0,1,1.78,1A7,7,0,0,1,8,15Z" /> -->
	<image href="/Projects/SchoolManagementSystem/icons/people-icon.png" height="16" width="16" />
</symbol>
<symbol id="result" viewBox="0 0 16 16">
	<image href="/Projects/SchoolManagementSystem/icons/document-scroll-icon.png" height="16" width="16" />
...
<symbol id="bye" viewBox="0 0 16 16">
	<image href="/Projects/SchoolManagementSystem/icons/Sign-Shutdown-icon.png" height="16" width="16" />
</symbol>
<symbol id="student" viewBox="0 0 16 16">
	<image href="/Projects/SchoolManagementSystem/icons/10207-man-student-light-skin-tone-icon.png" height="16"
		width="16" />
</symbol>
...
<symbol id="fee" viewBox="0 0 16 16">
	<image href="/Projects/SchoolManagementSystem/icons/coins-icon.png" height="16" width="16" />
</symbol>
...
<nav>
	<a href="#0">
		<img class="logo" src="/Projects/SchoolManagementSystem/icons/heyzap-icon.png"  height="40" width="40" alt="TheManager">
	</a>
...
<section class="search-and-user">
	...
	<div class="admin-profile">
		<span class="greeting"> <?php echo "Hello ".$session_name ?> </span>
